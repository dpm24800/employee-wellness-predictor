...
from src.components.dfsd.data_transformatio import DataTransformationConfig
from src.components.dfsd.data_transformatio import DataTransformation
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        ...
        try:
            df = pd.read_csv("notebook/data/WorkFromHomeBurnout.csv")
